# 1.6.2
* Changed gemspec. Added introduction text to program itself specifying what the program is and that it is no longer actively developed.

# 1.6.1
* Removed donation information as this project is no longer actively developed.
